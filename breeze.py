...
session = boto3.Session(profile_name='breeze')
...
def has_pending_snapshot(volume):
    ...
    return snapshots & snapshots[0].state == 'pending'


@click.group()
def cli():
    """Breeze manages snapshots"""
...
def create_snapshots(project):
    ...
    for i in instances:
        ...
        for v in i.volumes.all():
            ...
            v.create_snapshot(Description="Created by Breeze")
